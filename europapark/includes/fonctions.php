...
function ajouter_reservation($id_client, $prix, $type_lieu_aller, $type_lieu_retour, $adresse_aller, $adresse_retour, $date_aller, $date_retour, $nb_pers){
	...
	if ($type_lieu_retour != 0 && $type_lieu_aller != 0)
	{
		...
		// Le trajet Aller
		$bdd->query("	INSERT INTO europa_trajet(type_trajet, date_trajet, adresse, nb_pers, service_trajet, code_chauffeur, code_vehicule, estValide)
						VALUES (
							'ALLER',
							'" . $date_aller . "',
							'" . $adresse_aller . "',
...
function form_paypal($somme, $desc, $custom, $lang)
{
	...
	$form = array(
				...
				'return' => 'http://alsace-navette.com/europapark/confirmationPaypal.php', 						//Adresse de retour lorsque l'utilisateur clique sur retouner à la boutique
				'cancel_return' => 'http://alsace-navette.com/europapark/annulationPaypal.php',	//Adresse de retour pour les annulations
				'no_note' => '1', 								//Empeche l'utilisateur de rajouter des commentaires a son paiement.
				'notify_url' => 'http://alsace-navette.com/europapark/ipn.php' 					//Url appelee par paypal lors du paiement, cette page permettra le traitement des commandes payees.
			);
