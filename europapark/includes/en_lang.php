<?php
	...
	*/
	...
	$lang_titre_main = "Laissez vous conduire à Europa Park";
	...
	*/	
	...
	// Mail de paiement
	$lang_sujet_mail_paiement = "Paiement d'une navette pour Europa-Park";
	$lang_contenu_mail_paiement_1 = "<html><head></head><body>Bonjour,<br /><br />Nous avons bien recu votre paiement de ";
	$lang_contenu_mail_paiement_2 = " €. Votre navette est donc confirmée.<br /><br />Vous pouvez télécharger votre facture ici : <a href='http://alsace-navette.com/europapark/gen_facture.php?f=";
	$lang_contenu_mail_paiement_3 = "'>Votre facture</a><br /><br />Alsace-navette vous souhaite un agréable voyage !</body></html>";
	
	// Page Réservation
	$lang_effectuez_reservation = "Formulaire de demande<br /><br />Complete your booking now !";
	$lang_vos_informations = "Your informations";
	$lang_le_trajet = "The drive";
	...
	$lang_heure_retour = "Heure de prise à Europa-Park";
