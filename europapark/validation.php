<?php
	...
	*/
	if (!isset($_POST['txt_nom']) || $_SESSION["service"] != "europa"){ 
	...
	*/
	...
	ajouter_reservation($_SESSION["id_client"], $_SESSION["trajet"]["prix"], $_SESSION["trajet"]["lieu_aller"], $_SESSION["trajet"]["lieu_retour"], $_SESSION["trajet"]["adresse_aller"], $_SESSION["trajet"]["adresse_retour"], $_SESSION["trajet"]["date_aller"], $_SESSION["trajet"]["date_retour"], $_SESSION["trajet"]["nb_personnes"]);
	...
	$custom = $_SESSION["id_reserv"]."|".$_SESSION['lang']."|".$_SESSION["trajet"]["prix"]."|EUROPA";
			...
			<div id="contenu">
				...
				<?php
					...
					<fieldset class="spaced_fieldset">
						...
						<p><b>'.$lang_nombre_personnes.' :</b> '.$_SESSION["trajet"]["nb_personnes"].'<br />
						<b>'.$lang_nous_vous_cherchons_a.' :</b> '.get_nom_lieu($_SESSION["trajet"]["lieu_aller"]).'<br />';
						...
						echo $_SESSION["trajet"]["jour_aller_long"].' '.$lang_a_heure_min.' '.$_SESSION["trajet"]["heure_aller"];
						echo '
						</p>
					</fieldset>
					...
					<fieldset class="spaced_fieldset">
						...
						<p><b>'.$lang_nous_vous_cherchons_a.' :</b> Europa-Park<br />
						'.$_SESSION["trajet"]["jour_retour_long"].' '.$lang_a_heure_min.' '.$_SESSION["trajet"]["heure_retour"].'<br />
						'.$lang_et_vous_deposons_a.' '.get_nom_lieu($_SESSION["trajet"]["lieu_retour"]).'</p>';
					...
					<div style="width:100%;text-align:center;">
						<a href="http://alsace-navette.com/europapark/" title="'.$lang_modifier_mes_infos.'">'.$lang_modifier_mes_infos.'</a>
						<br />
					</div>
					...
					<fieldset class="spaced_fieldset">
						...
						<table class="table_reserv">
							...
							// Ajout de la majoration car jours différents
							if ($_SESSION["trajet"]["jour_aller"] != $_SESSION["trajet"]["jour_retour"]){
								echo '
								<tr>
									<th>'.$lang_majoration_jour_different.'</th>
									<td>+ '.get_value_of_option("supplement_differe").'€</td>
								</tr>';
							}
							// Ajout de la majoration car recherche à domicile
							if (($_SESSION["trajet"]["lieu_aller"] == 4 || $_SESSION["trajet"]["lieu_retour"] == 4) && get_value_of_option("maj_domicile") > 0)
							{
								echo '
								<tr>
							...
							// Ajout de la majoration car horaire à la demande
							if ($_SESSION["trajet"]["demande"] && get_value_of_option("maj_demande") > 0)
							{
								echo '
								<tr>
									<th>'.$lang_majoration_demande.'</th>
									<td>+ '.get_value_of_option("maj_demande").'€</td>
								</tr>';
							}
							...
							<tr>';
								...
								<td style="text-align:center;">
									...
									<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
										...
										<input type="hidden" name="encrypted" value="'.form_paypal($_SESSION["trajet"]["prix"],"Trajet aller-retour pour Europa-Park", $custom ,"FR").'" />
