<?php
   session_start();
    ...
    if(isset($_POST['paiement_ca']))
    {
        ...
        $PBX_EFFECTUE    = "http://alsace-navette.com/europapark/confirmationPaypal.php";
        $PBX_REFUSE      = "http://alsace-navette.com/europapark/annulationPaypal.php";
        $PBX_ANNULE      = "http://alsace-navette.com/europapark/annulationPaypal.php";
