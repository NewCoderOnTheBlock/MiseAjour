<?php
   session_start();
    ...
    if(isset($_POST['paiement_ca']))
    {
        ...
        $PBX_EFFECTUE    = "http://alsace-navette.com/outlet/confirmationPaypal.php";
        $PBX_REFUSE      = "http://alsace-navette.com/outlet/annulationPaypal.php";
        $PBX_ANNULE      = "http://alsace-navette.com/outlet/annulationPaypal.php";
