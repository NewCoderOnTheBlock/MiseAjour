<?php
	...
	<page style="font-size: 18pt">
		...
		<table cellspacing="0" style="width: 100%; font-size: 18px;">
			...
			<tr>
				<td style="text-align:right;margin-right:10px;"><u>Aller</u> : </td>
				<td> '.$libelle_aller_r.' le '.date("d/m/Y à H:i", strtotime($date_aller_r)).' <br />vers '.$lieu_trajet.'</td>
			</tr>';
			...
			<tr>
				<td style="text-align:right;margin-right:10px;"><u>Retour</u> : </td>
				<td> '.$lieu_trajet.' le '.date("d/m/Y", strtotime($date_retour_r)).' à '.$heure_depart_outlet->format("%H:%I").' <br />vers '.$libelle_retour_r.' à '.date("H:i", strtotime($date_retour_r)).'</td>
			</tr>';
