...
<BODY onLoad="javascript: <?php echo $onLoad."show_clock();document.getElementById('tabPhenix').style.height = document.body.clientHeight;".((($tcMenu==_MENU_PLG_HEBDO_GBL || $tcMenu==_MENU_PLG_QUOT_GBL) && !$tcType) ? "ChangeScreen();" : "").$sAlert; ?>" leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" marginwidth="0" marginheight="0">
