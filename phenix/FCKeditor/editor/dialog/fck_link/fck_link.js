...
function OnUploadCompleted( errorNumber, fileUrl, fileName, customMsg )
{
	...
	switch ( errorNumber )
	{
		...
		case 101 :	// Custom warning
			...
			break ;
		case 201 :
			alert(FCKLang.DlgUploadErr201 + fileName + '".');
			break ;
		case 202 :
			alert(FCKLang.DlgUploadErr202);
			return ;
		case 203 :
			alert(FCKLang.DlgUploadErr203);
			return ;
		case 500 :
			alert(FCKLang.DlgUploadErr500);
			break ;
		default :
			alert(FCKLang.DlgUploadErrDefault + errorNumber ) ;
			return ;
	}
