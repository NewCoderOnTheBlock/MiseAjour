...
if (ie4) {
  ie5 = (navigator.userAgent.indexOf('MSIE 5')>0 || navigator.userAgent.indexOf('MSIE 6')>0 || navigator.userAgent.indexOf('MSIE 7')>0 || navigator.userAgent.indexOf('MSIE 8')>0) ? true : false;
} else {
  ie5 = false;
}
