...
function ajouter_reservation($id_client, $prix, $type_lieu_aller, $type_lieu_retour, $adresse_aller, $adresse_retour, $date_aller, $date_retour, $nb_pers, $commentaire){
	...
	{
		$commentaire = $commentaire == "" ? "Véhicule " . $nb_pers . " places" : $commentaire."<br />Véhicule " . $nb_pers . " places";
...
function form_paypal($somme, $desc, $custom, $lang)
{
	...
	$form = array(
				...
				'return' => 'http://alsace-navette.com/laissezvousconduire/confirmationPaypal.php', 						//Adresse de retour lorsque l'utilisateur clique sur retouner à la boutique
