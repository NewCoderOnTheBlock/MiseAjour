...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	<head>
		...
		<title>Alsace Solidaire - RAJ Plus</title>
	</head>
<body>
	...
	<div id='contenu'>
		...
		<div style='width:770px;height:773px;font-size:12pt;background:url(./img/fiche/feuilleRAJP.png) no-repeat;margin-left:auto;margin-right:auto;text-align:left;padding-top:230px;'>
		<div style='margin-left:100px;width:400px;float:left;margin-right:50px;'>
			<?php
				if(isset($_GET['lang']))
				{
					...
					<div class='contenuText'>Atelier Réseau Active Job Plus</div>
					<div class='titre'>Date de création</div>
					<div class='contenuText'>Mars 2010</div>
					<div class='titre'>Cible</div>
					<div class='contenuText'>Les actifs et les seniors de 50 ans et plus</div>
					...
					<div class='contenuText'>C’est une action orientée vers les jeunes adultes, les actifs et les seniors de 50 ans et plus qui rencontrent des difficultés dans la construction de leur projet professionnel, notamment dans la recherche d’une formation ou d’un emploi. Tout ceci, afin de faciliter leur insertion dans la vie professionnelle à travers un dispositif d’accompagnement individuel.</div>
					...
					<div class='contenuText'>The assets and seniors of 50 and over</div>
					...
					<div class='contenuText'>It's an action oriented to young adults, actives and older than 50 years which meet orientation difficulties or problem to construct their professional project, especialy when they're searching for a formation or a job. This to facilitate their professional insertion accross an individual accompaniment device.</div>
					<div class='divLien'><a href='http://atelier-raj.org/' class='lien' style='color:#F39C17' target='blank'>www.atelier-raj.org</a></div>
					<?php
					}
		...
		<div id='menuLateral'>
			<a href='./fiche_RAJP.php?lang=<?php echo $_GET['lang']; ?>' style='color:white'>RAJ Plus</a>
