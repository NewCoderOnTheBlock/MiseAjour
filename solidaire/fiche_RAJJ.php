...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	<head>
		...
		<title>Alsace Solidaire - RAJ Junior</title>
	</head>
<body>
	...
	<div id='contenu'>
		...
		<div style='width:770px;height:773px;font-size:12pt;background:url(./img/fiche/feuilleRAJJ.png) no-repeat;margin-left:auto;margin-right:auto;text-align:left;padding-top:230px;'>
		<div style='margin-left:100px;width:400px;float:left;margin-right:50px;'>
			<?php
				if(isset($_GET['lang']))
				{
					...
					<div class='contenuText'>Atelier Réseau Active Job Junior</div>
					<div class='titre'>Date de création</div>
					<div class='contenuText'>Mars 2010</div>
					<div class='titre'>Cible</div>
					<div class='contenuText'>Les jeunes de 14 à 18 ans</div>
					...
					<div class='contenuText'>C’est une action orientée vers les jeunes de 14 à 18 ans qui rencontrent des difficultés dans le choix de leur orientation ou dans la construction de leur projet professionnel, notamment dans la recherche d’un stage, d’une formation ou d’un emploi. Tout ceci, afin de faciliter leur insertion dans la vie professionnelle ou d’intégrer ces personnes en difficultés dans un lieu de stage ou de formation.</div>
					...
					<div class='contenuText'>Young people 14-18 years</div>
					...
					<div class='contenuText'>It's an action oriented to 14-18 years old which meet orientation difficulties or problem to construct their professional project, especialy when they're searching for a stage, a formation or a job. This to facilitate their professional insertion or to integrate ths people on their training or formation.</div>
					<div class='divLien'><a href='http://atelier-raj.org/' class='lien' style='color:#F39C17' target='blank'>www.atelier-raj.org</a></div>
					<?php
					}
		...
		<div id='menuLateral'>
			...
			<div style='font-weight:bold;border-bottom:0.1px solid #555;clear:both;margin-bottom:10px;height:2px;width:170px'>&nbsp;</div>
			<a href='./fiche_RAJJ.php?lang=<?php echo $_GET['lang']; ?>' style='color:white'>RAJ Junior</a>
			<div style='font-weight:bold;border-bottom:0.1px solid #555;clear:both;margin-bottom:10px;height:2px;width:170px'>&nbsp;</div>
