<?php
	...
	*/
	...
	$lang_titre_main = "Laissez vous conduire à TheStyleOutlets : Roppenheim";
	...
	*/	
	...
	// Mail de paiement
	$lang_sujet_mail_paiement = "Paiement d'une navette pour TheStyleOutlets : Roppenheim";
	$lang_contenu_mail_paiement_1 = "<html><head></head><body>Bonjour,<br /><br />Nous avons bien recu votre paiement de ";
	$lang_contenu_mail_paiement_2 = " €. Votre navette est donc confirmée.<br /><br />Vous pouvez télécharger votre facture ici : <a href='http://alsace-navette.com/roppenheim/gen_facture.php?f=";
	...
	$lang_heure_retour = "Heure de prise à Roppenheim";
	...
	$lang_plus_de_navette_dispo = "Il n'y a plus de navette disponible à ces horaires là.";
	...
	$lang_tarif_texte_prix = "Le tarif est de ".get_value_of_option('tarif_min_aller_retour')." € par personne.";
	...
	// Page informations 
	$lang_titre_horaire_ouverture = "Horaires d'ouverture de TheStyleOutlets : Roppenheim";
	$lang_info_ouverture_tso = "Tout les jours, de 09h00 à 20h00";
	$lang_plus_d_info = "Pour plus d'informations, <a target=\"blank_\" href=\"http://thestyleoutlets.com/\">cliquez ici</a>";
	
	$lang_titre_formule_horaire = "Formules horaires";
	$lang_informations_complementaires = "Informations complémentaires";
	$lang_texte_info_compl = "
	<ul>
		<li>Les trajets se font uniquement le Samedi. Pour effectuer une demande d'un trajet sur un autre jour de la semaine, merci de nous contacter.</li>
		<li>Le temps de trajet est estimé à 40 minutes depuis Strasbourg gare.</li>";
	if (get_value_of_option('maj_domicile') > 0){
		$lang_texte_info_compl .= "<li>Le service prise ou dépôt à domicile est facturé ".get_value_of_option('maj_domicile')." €.</li>";
	}
	$lang_texte_info_compl .= '</ul>';
