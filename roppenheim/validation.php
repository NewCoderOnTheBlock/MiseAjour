<?php
	...
	*/
	if (!isset($_POST['id_trajet']) || $_SESSION["service"] != "roppenheim"){ 
	...
	$custom = $_SESSION["id_reserv"]."|".$_SESSION['lang']."|".$_SESSION["trajet"]["prix"]."|ROPPENHEIM|".$id_trajet;
			...
			<div id="contenu">
				...
				<?php
					...
					<div style="width:100%;text-align:center;">
						<a href="http://alsace-navette.com/roppenheim/" title="'.$lang_modifier_mes_infos.'">'.$lang_modifier_mes_infos.'</a>
						<br />
					</div>
