<?php
	...
	// On crée les navettes obligatoires (Samedi en l'occurence) (Pseudo-CRON)
	creer_les_trajets_obligatoires($_POST['jour']);
	...
	*/
	...
	// Date Aller
	list($heure_aller, $minute_aller) = split(':', get_heure_pack(intval($_POST['select_formule']), "aller"));
	// On formate la date
	...
	// Date Retour
	list($heure_retour, $minute_retour) = split(':', get_heure_pack(intval($_POST['select_formule']), "retour"));
	// On formate la date
	$d_explode = explode('-',$_POST['jour']);
		...
		<div id="global">
			...
			<div id="contenu">
				...
				<?php
					...
					<form name="form_reserv" method="post" action="choix_navette.php" id="form_reservation">
