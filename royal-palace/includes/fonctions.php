	...
	if ($type_lieu_retour != 0 && $type_lieu_aller != 0)
	{
		...
		$bdd->query("	INSERT INTO europa_trajet(type_trajet, date_trajet, adresse, adresse_2, nb_pers, service_trajet, code_chauffeur, code_vehicule, estValide)
						VALUES (
							...
							'" . $date_aller . "',
							'" . $adresse_aller . "',
							'Royal-Palace<br />20, rue de Hochfelden<br />67330 Kirrwiller',
							'" . $nb_pers . "',
							'ROYAL',
							'6',
							'8',
...
function form_paypal($somme, $desc, $custom, $lang)
{
	...
	$form = array(
				...
				'return' => 'http://alsace-navette.com/royal-palace/confirmationPaypal.php', 						//Adresse de retour lorsque l'utilisateur clique sur retouner à la boutique
				'cancel_return' => 'http://alsace-navette.com/royal-palace/annulationPaypal.php',	//Adresse de retour pour les annulations
				'no_note' => '1', 								//Empeche l'utilisateur de rajouter des commentaires a son paiement.
				'notify_url' => 'http://alsace-navette.com/royal-palace/ipn.php' 					//Url appelee par paypal lors du paiement, cette page permettra le traitement des commandes payees.
			);
