<?php
	...
	*/
	...
	$lang_titre_main = "Laissez vous conduire à Royal Palace";
	...
	*/	
	...
	$lang_heure_retour = "Heure de prise à Royal Palace";
	$lang_lieu_aller = "Lieu de prise";
	$lang_lieu_retour = "Lieu de dépot";
	$lang_info_complementaires = "Informations complémentaires";
	
	$lang_option_du_midi = "Du midi";
	$lang_option_du_soir = "Du soir";
	$lang_option_repas_spectacle = "Repas + Spectacle";
	$lang_option_spectacle = "Uniquement spectacle";
	...
	$lang_demande_particuliere = "Demande particulière";
	...
	<ul>
		<li>Le prix total est calculé en fonction du nombre de personnes.</li>";
		...
		if (get_value_of_option('maj_hors_stras_par_km') > 0){
			$lang_tarif_info_compl .= "<li>La prise ou dépôt à domicile hors Strasbourg est majoré d'un montant de ".get_value_of_option('maj_hors_stras_par_km')." €.</li>";
		}
		if (get_value_of_option('maj_only_spectacle') > 0){
			$lang_tarif_info_compl .= "<li>Le fait de choisir un trajet pour le spectacle uniquement est majoré d'un montant de ".get_value_of_option('maj_only_spectacle')." € par personnes.</li>";
		}
		$lang_tarif_info_compl .= "
	</ul>";
	...
	$lang_plus_d_info = "Pour plus d'informations, <a target=\"blank_\" href=\"http://www.royal-palace.com/menus-tarifs.html\">cliquez ici</a>";
	$lang_informations_complementaires = "Informations complémentaires";
	$lang_texte_info_compl = "
	<ul>
		<li>Il est possible de choisir une navette pour le spectacle uniquement.</li>
		...
		if (get_value_of_option('maj_only_spectacle') > 0){
			$lang_texte_info_compl .= "<li>Le fait de choisir un trajet pour le spectacle uniquement est majoré d'un montant de ".get_value_of_option('maj_only_spectacle')." € par personnes.</li>";
		}
		$lang_texte_info_compl .= "
		<li>Le prix total est calculé en fonction du nombre de personnes.</li>
	</ul>
...
";
	...
	$lang_majoration_spectacle_only = "Majoration spectacle uniquement";
	$lang_total = "Total";
