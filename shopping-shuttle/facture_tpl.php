<?php
	...
	<page style="font-size: 18pt">
		...
		<table cellspacing="0" style="width: 100%; font-size: 18px;">
			...
			<tr>
				<td>Aller-retour pour TheStyleOutlets : Roppenheim</td>
				<td></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td> '.$libelle_aller_r.' le '.date("d/m/Y à H:i", strtotime($date_aller_r)).' <br />vers TheStyleOutlets</td>
			</tr>';
			...
			<tr>
				...
				<td> TheStyleOutlets le '.date("d/m/Y à H:i", strtotime($date_retour_r)).' <br />vers '.$libelle_retour_r.'</td>
			</tr>';
