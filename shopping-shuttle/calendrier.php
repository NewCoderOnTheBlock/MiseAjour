...
<body>
      ...
      <div id="calendrier" class="conteneur calendrier" style="width:560px;background-color:#c6c3de;">
      ...
      <div style="position: relative; width: 560px;">
          <div id="top-panel" style="background-color : #9791cb;position: relative;width: 560px;z-index: 1500;">
              <a class="voir_plus" href="javascript:void(0);" id="code-button" onclick="PullDown.panel.toggle(); return false;">
                  + Voir les navettes disponibles
              </a>
          </div>
          <div id="main-part">
          	<div id="outer_panel" class="panel-top" style="overflow: hidden; position: absolute; z-index: 1600;top: 19px; width: 560px;height: 132px;">
