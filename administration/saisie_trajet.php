<?php
	...
	if(isset($_POST['nv_trajet']) && $_POST['hdn_date'] != "")
	{
		...
		// insertion du trajet
		$sql = "INSERT INTO aeroport_trajet VALUES('0', '6', '', '" . intval($_POST['depart']) . "', '" . intval($_POST['dest']) . "', '" . $_POST['hdn_date'] . " " . $_POST['heure'] . ":" . $_POST['minute'] . ":00', '0', '0', '" . $estFixe . "', '0', '0', '0')";
...
?>
	...
	<form method="post" action="saisie_trajet.php">
