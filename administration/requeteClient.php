...
$sql= "SELECT d_depart,h_depart,nb_personnes,typetrajet,depart,destination,h_vol,n_vol,rassemblement,demande,date,paiement,montant,nom,reservation FROM vue_globale where paiement <> '' and nom like '".$client."%' ORDER BY d_depart desc";
...
// prendre la liste des champs 
$sql= "SELECT d_depart,h_depart,nb_personnes,typetrajet,depart,destination,h_vol,n_vol,rassemblement,demande,date,paiement,montant,nom, reservation FROM vue_globale where paiement = '' and nom like '".$client."%' and d_depart >= '".date('Y-m-d')."' ORDER BY d_depart desc";
