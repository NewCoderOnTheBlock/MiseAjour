...
if ($ligne = mysql_fetch_array($result)) 
{
	...
	echo "<table>\n";
    echo "<thead><th>ID</th><th>Date</th><th>Conducteur</th><th>Service</th><th>Navette</th><th>Lieu de dépot</th><th>Remarques</th><th>Groupes</th><th>Passagers aller</th><th>Passagers retour</th><th>Payé</th><th>Départ</th><th>Arrivée</th><th>Durée</th><th>Domicile</th><th>KmsD</th><th>KmsA</th><th>Kms</th><th>EssenceD</th><th>EssenceA</th><th>Payé Essence</th><th>Lavage EXT</th><th>Lavage INT</th><th>Unités</th></thead>\n";
	do 
	{
        echo"<tr><td>$ligne[0]</td><td>$ligne[2]</td><td>$ligne[3]</td><td>$ligne[4]</td><td>$ligne[5]</td><td>$ligne[24]</td><td>$ligne[6]</td><td>$ligne[7]</td><td>$ligne[8]</td><td>$ligne[9]</td><td>$ligne[10]</td><td>$ligne[11]</td><td>$ligne[12]</td><td>$ligne[13]</td><td>$ligne[14]</td><td>$ligne[15]</td><td>$ligne[16]</td><td>$ligne[17]</td><td>$ligne[18]</td><td>$ligne[19]</td><td>$ligne[20]</td><td>$ligne[21]</td><td>$ligne[22]</td><td>$ligne[23]</td>";
		echo "<td><b>";
		echo "</a></b></td>";
	} 
