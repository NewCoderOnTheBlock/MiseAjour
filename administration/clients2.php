...
$nom=$_GET["ID"];
$mysql_result1 = mysql_query("SELECT distinct nom, prenom,e_mail,telephone,portable,ville,pays,n_voie,type_voie,nom_voie,code_postal FROM formulaire_demande where nom='".$nom."'");
