...
<div style="width:100%;">
	<div style="text-align:center;margin:auto;">
      ...
      <form name="form" id="form">
		  ...
		  ?>
            <option value="index3.php?p=1&id_news=<?php echo $id_list;?>"><?php echo $titre_list;?></option>
          <?php
		  }
		  ?>
          </select>
      ...
      <br>
      <br>
      <form id="form1" name="form1" method="post" action="index3.php?p=1&id_news=<?php echo $id_list;?>&action=suppr">
        <input type="hidden" name="id_news" value="<?php echo $_GET['id_news']; ?>">
        <input type="submit" name="supp" id="supp" value="Supprimer" />
      </form>
      <br>
      <br>
      <form id="form2" name="form2" method="post" action="index3.php?p=1">
        <input type="submit" name="supp" id="supp" value="Nouvelle" />
      </form>
      <form id="form5" action="index3.php?p=2" method="post">
      </form>
      <br />
        <br />
        <form action="index3.php?p=1" method="post" name="form" style="width:775px;margin-left:auto;margin-right:auto;">
            <input type="hidden" name="id_news" value="<?php echo $_GET['id_news']; ?>">
           ...
           <select name="categorie">
                ...
                <?php
                    ...
                    while($row = mysql_fetch_assoc($ret))
                    {
                        ...
                        echo '<option value="' . $row['id_cat'] . '"' . $selected . '>' . $row['cat_fr'] . '</option>';
                    }
                ?>
           </select>
           ...
           <textarea name="texte_fr" style="width:100%; height:200px;"><?php echo $texte_fr; ?></textarea>
           <br/><br/>
