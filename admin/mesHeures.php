...
Modification par MARC CESCUTTI
...
le switch ($mois){
			case 01 :
						...
						ainsi que pour toutes ces occurences.
...
**/
	...
	$statement=$db->prepare($req_heure_chauff);
	$statement->execute();
	$result6=$statement->fetchAll();
					
    $res_heure_chauff =$statement->fetch(PDO::FETCH_ASSOC);
	...
	$statement=$db->prepare($res_heure_chauff);
	$statement->execute();
