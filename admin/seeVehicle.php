  ...
  <form name="form" id="form">
    <select name="jumpMenu" size="10" id="jumpMenu" onchange="MM_jumpMenu('parent',this,0)">
      <?php
        ...
        $queryVehicule = "select * from aeroport_vehicule where id_vehicule != 6";
        ...
        while ($r = @mysql_fetch_assoc($resultVehicule)){
            ...
            ?>
      <option  value="index.php?p=13&idV=<?php echo $id_vehicule; ?>"><?php echo $libelle." ".$prenom; ?></option>
      <?php } ?>
    </select>
  </form>
</div>
...
<form id="form1" name="form1" action="index.php?p=13&idV=<?php echo $id_vehicule2; ?>&action=2" method="post" >
  ...
  <div class="CollapsiblePanelTab" id="barre<?php echo $id_trajet; ?>" <?php if($estComment == 0){ ?>style="background-color:#CF6;"<?php } ?>  >
    ...
    <table id="tbl<?php echo $id_trajet; ?>" width="1650px" border="0" cellpadding="1" style="font-family:Verdana, Geneva, sans-serif;">
      <tr>
        ...
        <th style="width:150px;" id="tab_vehicule_<?php echo $id_trajet; ?>"><?=$libelle?></th>
        <th style="width:150px;"><?=(($estPaye == 1) ? "Est payé" : "Non payé")?></th>
        <th></th>
      </tr>
    </table>
  </div>
    ...
    <div style="overflow-x:hidden; overflow-y:auto; width:100%; height:100%;">
      <?php
		...
		$query4 = "SELECT 	ligne.id_ligne as idRes,
					...
					AND tr.id_vehicule = ".$idV."
					AND ligne.id_trajet = tr.id_trajet
			...
			while($r_com = @mysql_fetch_assoc($res_com)){
				...
				?>
					  ...
					  <table border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td width="350px"><strong><a href="index.php?p=23&id_recap=<?php echo $id_recap;?>"> Modifier cette fiche récap </a></strong></td>
						</tr>
						<tr>
