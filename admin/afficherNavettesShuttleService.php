                            ...
                            while ($r4 = @mysql_fetch_assoc($result4)){
								...
								<tr id="ligne<?php echo $idRes; ?>" style="<?=$bonus_background?>">
                                    ...
                                    <td>
										...
										<u>Prix</u> : <a onclick="window.open(this.href, 'Modification du prix d\'réservation', 'width=450,height=300,resizable=yes'); return false;" href="modif_prix.php?id_res=<?php echo $id_res; ?>&id_trajet=<?php echo $id_trajet; ?>&id_ligne=<?php echo $idRes; ?>&id_facture=<?php echo $id_de_la_facture; ?>&id_affiche=prix_<?php echo $id_affiche; ?>" id="prix_<?php echo $id_affiche; ?>"><?php echo ($prix); ?> €</a>
										<br />
