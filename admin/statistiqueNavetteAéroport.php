	...
	<?php
		...
		if (isset($_POST['annee'])){
			...
			*/
				// Nombre total
			$query = "	SELECT 	*,
								COUNT(trajet.id_lieu_depart) as nb_lieu_depart
									
						FROM aeroport_trajet trajet
						WHERE trajet.est_paye = 1
			...
			echo "
				<h2>Navettes aéroport vers Strasbourg</h2>
			...
			*/
				// Nombre total
			$query = "	SELECT 	*,
								COUNT(trajet.id_lieu_dest) as nb_lieu_dest
			...
			echo "
				<br />
				<h2>Navettes Strasbourg vers aéroport</h2>
				<table width='50%' align=center style='text-align:left;'>
					<tr>
						<th width='50%' style='text-align:right'>Aeroport</th>
						<th width='50%' style='text-align:center'>Nombre</th>
