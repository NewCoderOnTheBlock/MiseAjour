...
*/		
        ...
        $tpl->set(array(
                    ...
                    "TAB_HEADER" => get_tab_navette_existant2(),
...
*/
	...
	if($_SESSION['trajet']['type_trajet'] == 0 )
	{
        ...
        {    $prix1 = $prix_personne * ($_SESSION['trajet']['passager_adulte_retour'] + $_SESSION['trajet']['passager_enfant_retour']);
            $prix_navette_retour = $prix_personne * ($_SESSION['trajet']['passager_adulte_retour'] + $_SESSION['trajet']['passager_enfant_retour']); }
        else
		...
		$res = mysql_query($req);
		$_SESSION['id_demande_annulee'] = mysql_insert_id();
		mysql_close($c); 
		$tpl->set(array(
		...
		switch($langue){            
            ...
            case 'fr':
 			$content_mail = "<html><head></head><body>Bonjour,<br /><br />Vous avez effectué une recherche de navette sur notre site alsace-navette.com.";
			$content_mail .= "<br />Nous vous rappelons les informations :<br />";
			if($_SESSION['trajet']['type_trajet'] == 0)
			{
			...
			if($_SESSION['trajet']['pt_rass_aller'] == 4)
			{
				...
				$_SESSION['trajet']['rass_cp_aller']." ".
				$_SESSION['trajet']['rass_ville_aller']."<br />";
			}
	...
	$prix_aller = $prix_navette_aller + $prix_dernière_minute_aller + $prix_horaire_demande_aller + $prix_horaire_nuit_aller + $prix_montant_domicile_aller - $prix_remise_aller;
			...
			if($_SESSION['trajet']['type_trajet'] == 0)
			{
				...
				if($_SESSION['trajet']['pt_rass_retour'] == 4)
				{
					...
					$_SESSION['trajet']['rass_cp_retour']." ".
					$_SESSION['trajet']['rass_ville_retour']."<br />";
				}
	...
	$prix_retour = $prix_navette_retour + $prix_dernière_minute_retour + $prix_horaire_demande_retour + $prix_horaire_nuit_retour + $prix_montant_domicile_retour - $prix_remise_retour;
			...
			case 'en':
			 $content_mail = "<html><head></head><body>Hello,<br /><br />You have just looked up price shuttle information on alsace-navette.com.";
			$content_mail .= "<br />We remind you the price information:<br />";
			if($_SESSION['trajet']['type_trajet'] == 0)
			{
	...
	$prix_retour = $prix_navette_retour + $prix_dernière_minute_retour + $prix_horaire_demande_retour + $prix_horaire_nuit_retour + $prix_montant_domicile_retour - $prix_remise_retour;		
			...
			$content_mail .= "<br /><br />Alsace-navette wish you a pleasant day! <br /><br /><br />";
			$content_mail .= "alsace-navette.com/aeroport <br />2 rue du Coq 67000 Strasbourg <br />OFFICE : +33 (0) 388 222 271 <br/>URGENCE : +33 (0) 627 181 252 <br />info@alsace-navette.com</body></html>";
    		break;
