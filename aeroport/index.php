<?php
	...
	if(!isset($_SESSION['trajet']['rass_pays_retour'])){
	...
	$tpl->set(array(
					...
					"BTN_RAZ" => $btn_raz,
					"BTN_AFFICHER_TARIFS" => $btn_afficher_tarifs,
					...
					"TITLE_RESERVATION" => $title_demande,
					...
					"LICENCE" => $lang_licence,
					"TXT_EMAIL" => $_SESSION['client']['mail'],
					"EMAIL" => $email,
					"PASSWD" => $passwd,
