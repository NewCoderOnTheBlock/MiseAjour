...
function sendRequest(lst, type, type2, action, lieu)
{
	if(type == "depart")
	{
		xhr = get_xhr();
		...
		var param = "action=get_horaire_fixe&lst=" + lst + "&type=" + type + "&lieu=" + lieu + "&type2=" + type2;
...
function set_demande_annulee(nom, email, lieu_dep, lieu_dest, date, etape, prix, simple)
{
    var xhr = get_xhr();
    ...
    var param = "action=set_demande_annulee&nom=" + nom + "&email=" + email + "&date=" + date + "&lieu_dep=" + lieu_dep + "&lieu_dest=" + lieu_dest + "&etape=" + etape + "&prix=" + prix + "&simple=" + simple;
