 ...
 * */
			...
			if($_SESSION['txtNom']!="" || $_SESSION['txtNom']!=null)
				$reservation .= ",'".$_SESSION['txtNom']."'";
				else
				{
					$reservation .= ",'".$_SESSION['client']['nom']."'";
				}
            ...
            $mail_client .= "" . $tabulation . $indicatif_tel_autre_passager  . " : <strong>" .   $_SESSION['lstIndicatifTelephone']  . "</strong><br />";
