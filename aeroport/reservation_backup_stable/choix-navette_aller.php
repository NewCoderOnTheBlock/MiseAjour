 ...
 * **/
	...
	*/
	...
	if ($nb_res == 0){
		...
		$req = "INSERT INTO aeroport_demande_non_finalisee (date_demande, nom_client, email_client, id_lieu_dep, id_lieu_dest, date_aller, date_retour, estSimple, nbPers, langue) 
				VALUES (
					'" . date("Y-m-d H:i:s") ."',
	...
	*/
	...
	$req = "DELETE FROM aeroport_demande_non_finalisee
