<?php
	...
	{		
        ...
        $id_facture = $custom_r[10]; // Ajout KEMPF : l'ID de la facture
		...
		elseif($maj_paye == "1")
		{
           ...
           * **************************************/ 
            ...
            case 'en': 
			$content_mail = "<html><head></head><body>Hi,<br /><br />We have received your payment. Your shuttle is confirmed.<br /><br />Download your bill here : <a href='http://alsace-navette.com/aeroport/gen_facture_aeroport.php?f=".sha1($id_facture)."'>your bill en PDF <img src='http://alsace-navette.com/aeroport/images/icone_pdf.gif' /></a>.<br /><br />Alsace-navette wish you a pleasant journey !</body></html>";
            break;
            
            case 'ger': 
			$content_mail = "<html><head></head><body>Bonjour,<br /><br />Wir haben Ihre Zahlung erhalten. Ihr Shuttle wird bestätigt.<br /><br />Laden Sie Ihre Rechnung hier : <a href='http://alsace-navette.com/aeroport/gen_facture_aeroport.php?f=".sha1($id_facture)."'>Ihre Rechnung en PDF <img src='http://alsace-navette.com/aeroport/images/icone_pdf.gif' /></a>.<br /><br />Alsace-navette wünschen Ihnen eine angenehme Reise !</body></html>";
            break;
            ...
            if($row['res_der_min'] == "0" || get_prix($id_ligne1, "est_paye") == '1')
            {
                ...
                else
				{
					...
					*/
					...
					switch($langue){
						case 'fr': 
							$mail_client .= "<br /><br />Téléchargez votre facture ici : <a href='http://alsace-navette.com/aeroport/gen_facture_aeroport.php?f=".sha1($id_facture)."'>votre facture en PDF</a>.";
							break;
						
						case 'en': 
							$mail_client .= "<br /><br />Download your bill here : <a href='http://alsace-navette.com/aeroport/gen_facture_aeroport.php?f=".sha1($id_facture)."'>your bill en PDF</a>.";
							break;
						
						case 'ger': 
							$mail_client .= "<br /><br />Laden Sie Ihre Rechnung hier : <a href='http://alsace-navette.com/aeroport/gen_facture_aeroport.php?f=".sha1($id_facture)."'>Ihre Rechnung en PDF</a>.";
							break;
