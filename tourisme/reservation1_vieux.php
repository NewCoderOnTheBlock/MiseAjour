...
<body>
	...
	<div id="page">
		...
		<!--               ///////////////////////////////////////////////////////////contenu -->
				...
				<table height="30" border="1" bordercolor="#999999"  style="margin-left:59px;"  class = "tab_tarif" bgcolor="#FFFFFF">
					<thead> <!-- En-tête du tableau -->
						<tr>      
							<th width="100" height="15" class = "tab_col"><div align="left">Tarifs</div></th>
							<th width="100" class = "tab_col"><div align="center">Periode 1</div></th>
							<th width="100" class = "tab_col"><div align="center">Periode 2</div></th>
							<th width="100" class = "tab_col"><div align="center">Periode 3</div></th>
						</tr>
					</thead>
				...
				<form method="post" action= "reservation1_1.php" name ="formulaire">
												 <fieldset class="field" style="height:730px; float:left; width:350px; padding:10px; margin:10px;">
													...
													<label>Point de départ souhaité (supplément de 10€ si domicile)  :<br />
											     </label>
														  <select name="pt_dep">
													...
													<br /><br />
														...
														<fieldset id="choix_navette" style="height:730px; float:right; width:270px; padding:10px; margin:10px;">
															...
															<p>
																...
																<p>
																<label>Nombre personnes <u>(adultes+enfants)</u> <font color = "red">*</font> : </label>
																...
																<label>dont enfants (-12ans) :</label>
