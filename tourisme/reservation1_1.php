	...
	<div id="page">
		...
		<!--               ///////////////////////////////////////////////////////////contenu -->
								...
								<div id="special_reservation_1">
											...
											<strong>Nombre de personnes :</strong> <?php echo $nb_tot."<br />"; ?>
											
											<strong><br />
											Prix par personne :</strong> <?php echo $prix ."<br />"; ?><br>
											<strong>Tarif spécial enfant:</strong> <?php echo $prix-15; ?><br /><br />
